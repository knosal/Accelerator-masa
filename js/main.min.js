...
var _initAccordion = require("./vendor/accordions/init-accordion");
var _customSelect = require("./vendor/custom-select/custom-select");
var _initModals = require("./vendor/modals/init-modals");
var _iosVhFix = require("./utils/ios-vh-fix");
var _form = require("./vendor/form-validate/form");
var _initSwiperSlider = require("./modules/initSwiperSlider");
var _initNewsFilter = require("./modules/initNewsFilter");
var _removeLineBreaks = require("./modules/removeLineBreaks");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _menuToggle.initButtonMenu)();
  window.addEventListener('load', function () {
    createScript(); //pixelperfect;
    (0, _initModals.initModals)();
    (0, _initSwiperSlider.initAllSliders)();
    (0, _initAccordion.initAccordions)();
    (0, _initNewsFilter.initNewsFilter)();
    (0, _removeLineBreaks.initLineBreaksk)();
    (0, _map.initMap)();
...
},{"./modules/initNewsFilter":2,"./modules/initSwiperSlider":3,"./modules/map":4,"./modules/menuToggle":5,"./modules/removeLineBreaks":6,"./utils/ios-vh-fix":9,"./vendor/accordions/init-accordion":13,"./vendor/custom-select/custom-select":15,"./vendor/form-validate/form":18,"./vendor/modals/init-modals":25}],2:[function(require,module,exports){
"use strict";
...
var buttonContainer = document.querySelector('[data-news="button-container"]');
var newsBtns = buttonContainer.querySelectorAll('[data-name="news-button"]');
var newsSlides = document.querySelectorAll('[data-news="slide"]');
var isActive = 'is-active';

// Функция для обработки клика на кнопке новостей
var handleNewsButtonClick = function handleNewsButtonClick(clickedButton) {
  newsBtns.forEach(function (button) {
    return button.classList.remove(isActive);
  });
  clickedButton.classList.add(isActive);
};

// Функция для обновления отображения слайдов в зависимости от выбранной категории
var updateNewsSlides = function updateNewsSlides(filter) {
  newsSlides.forEach(function (slide) {
    var slideFilter = slide.dataset.filter;
    var shouldShow = filter === 'all' || slideFilter === filter;
...
var onBtnContainerClick = function onBtnContainerClick(evt) {
  var currentBtn = evt.target.closest('[data-name="news-button"]');
  if (currentBtn) {
    if (!currentBtn.classList.contains(isActive)) {
      handleNewsButtonClick(currentBtn);
    }
    var filter = currentBtn.dataset.filter || 'all';
...
var initSwiper = function initSwiper(selector, options) {
  ...
  if (element) {
    return new _swiper.default(selector, _objectSpread({
...
var sliders = {}; // Объект для хранения всех слайдеров

var setTabIndexAndInert = function setTabIndexAndInert(slide, pagination, button) {
...
var initAllSliders = function initAllSliders() {
  sliderConfigs.forEach(function (config) {
    var slider = initSwiper(config.selector, config.options);
    if (slider) {
...
var heroSlider = sliders['.hero__swiper'];
var heroSlides = heroSlider ? heroSlider.querySelectorAll('.hero__slide') : [];
heroSlides.forEach(function (slide) {
  var pagination = slide.querySelector('.hero__pagination');
  var button = slide.querySelector('.hero__slide-button');
  setTabIndexAndInert(slide, pagination, button);
});

},{"../utils/is-mobile":10,"../vendor/swiper":27}],4:[function(require,module,exports){
"use strict";
...
var initMap = function initMap() {
  ...
  if (map) {
    ...
    var coordinateMap = [55.0285253, 82.9269913];
    var coordinateMarker = [55.0285253, 82.9269913];
    var url = 'https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';

    // Переменные для размеров иконок в зависимости от ширины экрана.
    var iconSizeSmall = [30, 30]; // Размер для маленьких экранов (320px и меньше).
    var iconSizeMedium = [40, 40]; // Размер для средних экранов (321px - 768px).
    var iconSizeLarge = [48, 48]; // Размер для больших экранов (769px и больше).
    ...
    (0, _leaflet.tileLayer)(url).addTo(addMap);

    // Функция для создания маркера на карте.
    (0, _leaflet.marker)(coordinateMarker, {
      icon: icon
    }).addTo(addMap);
  }
};
...
},{"../vendor/leaflet":24}],5:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initButtonMenu = void 0;
var initButtonMenu = function initButtonMenu() {
  var isOpened = 'is-opened';
  var header = document.querySelector('.header');
  var container = header.querySelector('.header__container');
  var toggleBtn = header.querySelector('.navigation__button');
...
exports.initButtonMenu = initButtonMenu;
...
exports.initLineBreaks = void 0;
var featureTitles = document.querySelectorAll('[data-name="feature-title"]');
...
var initLineBreaks = function initLineBreaks() {
  if (featureTitles.length > 0) {
    breakpointChecker();
    window.addEventListener('resize', breakpointChecker);
  }
};
exports.initLineBreaks = initLineBreaks;
...
},{"./ios-checker":8}],10:[function(require,module,exports){
"use strict";
...
},{"./ios-checker":8}],12:[function(require,module,exports){
"use strict";
...
var Accordions = /*#__PURE__*/function () {
  ...
  _createClass(Accordions, [{
    ...
    value: function openAccordion(element) {
      ...
      var button = element.querySelector('[data-accordion="button"]');
...
},{"./callback":17,"./init-phone-input":19,"./validator":23}],19:[function(require,module,exports){
"use strict";
...
},{"./matrix":20,"./regular-expression":21,"./render-message":22}],24:[function(require,module,exports){
"use strict";
...
},{"./modals":26}],26:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":7,"../../utils/scroll-lock":11}],27:[function(require,module,exports){
